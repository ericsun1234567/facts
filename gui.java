...
public class gui extends JFrame {
	...
	public gui(FactList lis) {
		...
		lblNewLabel_6.setBounds(329, 25, 84, 14);
		contentPane.add(lblNewLabel_6);
		
		textField_1 = new JTextField();
		textField_1.setBounds(329, 46, 86, 107);
		...
		JLabel lblNewLabel_7 = new JLabel("Enter New Fact");
		lblNewLabel_7.setBounds(246, 236, 89, 14);
